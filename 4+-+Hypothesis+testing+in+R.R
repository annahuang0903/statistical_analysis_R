...
#                                                                       #
#  Like the z.test() function, if the sample mean is given instead of   #
#  the sample data, you will need to create a vector of sample data to  #
#  use as the input that has the appropriate mean and number of values. #
#                                                                       #
...
#  randomly selecting 10 courses from the current semester offerings    #
...
#  continuous distribution and uses the same hypotheses.                #
#                                                                       #
...
#########################################
#  Wilcoxon sign-rank test (continued)  #
#########################################
...
#  and each is given a new treatment. The observed counts are 118, 63,  #
